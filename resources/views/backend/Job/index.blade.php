                ...
                <div class="container-fluid p-4">
                    <div class="pagetitle">
                        ...
                        <div class="d-flex justify-content-between">
                            <h1>Manage job</h1>
                            <a href="{{ route('job.create') }}" class="btn btn-primary btn-md p-3"><i class="fa fa-plus"
                                        ...
                                        <tbody>
                                            @foreach ($jobs as $job)
                                                <tr>
                                                    ...
                                                    <td>{{ $job->title }}</td>
                                                    <td>
                                                        {{ Str::limit($job->description, 50, '...') }}</td>
                                                    </td>
                                                    <td>{{ $job->salary }}</td>
                                                    <td>
                                                        @if (Auth::id() === $job->user_id)
                                                            <a href="{{ route('job.applications', $job->id) }}"
                                                                class="btn btn-md btn-primary">View Application</a>
                                                        @endif
                                                    </td>
                                                    <td>
                                                        ...
                                                        @if (Auth::id() === $job->user_id)
                                                            ...
                                                            <button type="button" class="btn btn-danger btn-md"
                                                                ...
                                                                data-bs-target="#modalId{{ $job->id }}">
                                                                <i class="fa-solid fa-trash-can"></i>
                                                            </button>
                                                        @endif
                                                        <!-- Modal Body -->
                                                        <!-- if you want to close by clicking outside the modal, delete the last endpoint:data-bs-backdrop and data-bs-keyboard -->
                                                        <div class="modal fade" id="modalId{{ $job->id }}"
